...
* ***************************************************************/
    ...
    if (data && data.length > 0) {
        ...
        // 1. CLASSIC LUXURY BANNER LAYER (Centered, Black Background, Times New Roman Variant)
        ...
        data.forEach(vehicle => {
            ...
            viewHtml += `
                <article class="group bg-[#0D0D0D] border border-neutral-900 rounded-2xl overflow-hidden shadow-2xl hover:border-neutral-800 transition-all duration-300 transform hover:-translate-y-1.5 flex flex-col justify-between">
